...
<div class="modal fade" id="_{{$std->id}}" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
...
<div class="d-flex align-items-center gap-3">
    <a class="btn btn-info btn-sm d-flex align-items-center gap-1" data-bs-toggle="modal" href="#_{{$std->id}}" role="button">
